<script lang="ts">
	...
	const inputClass =
		'w-16 rounded-lg border border-line bg-surface-2 px-2 py-1.5 text-center font-mono text-ink outline-none transition focus:ring-2 focus:ring-brand focus:ring-offset-2 focus:ring-offset-surface';
</script>
...
<div class="mx-auto max-w-xl rounded-card border border-border bg-surface p-6 sm:p-8">
	<div class="flex flex-wrap items-center justify-center gap-4">
		...
		<select
			...
			class="rounded-lg border border-line bg-surface-2 px-3 py-2 text-xl text-brand outline-none transition focus:ring-2 focus:ring-brand focus:ring-offset-2 focus:ring-offset-surface"
		>
